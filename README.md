...
* **ua-parser-js** - Versions of a popular NPM package named ua-parser-js was found to contain malicious code [[Cybersecurity and Infrastructure Security Agency (CISA)]](https://us-cert.cisa.gov/ncas/current-activity/2021/10/22/malware-discovered-popular-npm-package-ua-parser-js), [[github issue]](https://github.com/faisalman/ua-parser-js/issues/536).
