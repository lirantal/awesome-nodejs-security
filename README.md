...
- [lavamoat](https://github.com/lavamoat/lavamoat) Uses `ses` to confine third-party dependencies and limits their access to host powers based on policies generated by trust-on-first-use static analysis.
